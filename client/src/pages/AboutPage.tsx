        ...
        <div className="relative">
          ...
          >
            ...
            >
              ...
              <image
                ...
                width={"100%"}
                height={"100%"}
               xlinkHref="https://images.unsplash.com/photo-1518770660439-4636190af475"
              ></image>
            </svg>
          </TimelineContent>
          ...
          <div className="flex flex-wrap lg:justify-start justify-between items-center py-3 text-sm">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-2 sm:text-base text-xs">
              <span className="text-red-500 font-bold">5000+</span>
            ...
            <div className="lg:absolute right-0 bottom-16 flex lg:flex-col flex-row-reverse lg:gap-0 gap-4">
              ...
              <span className="text-gray-600 uppercase">hiring partners</span>
              </TimelineContent>
              <TimelineContent
                as="div"
                animationNum={7}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            ...
            <h1 className="sm:text-4xl md:text-5xl text-2xl !leading-[110%] font-semibold text-gray-900 mb-8">
              ...
              >
                Empowering Careers Through Industry-Focused Tech Training
              </VerticalCutReveal>
            </h1>
            ...
            >
              ...
              >
                <p className="leading-relaxed text-justify">
                  TechElite IT Solutions is dedicated to bridging the gap between academic learning and real-world industry requirements.
                  Our training programs focus on practical skills, real-time projects, and modern technologies.
                </p>
              </TimelineContent>
              <TimelineContent
                as="div"
              ...
              >
                <p className="leading-relaxed text-justify">
                With experienced mentors, career guidance, and hands-on development training,
                we help students and professionals build successful careers in the technology industry.
                </p>
              </TimelineContent>
            </TimelineContent>
          </div>
          ...
          <div className="md:col-span-1">
            <div className="text-right">
              ...
              >
                Industry Focused Training Institute
              </TimelineContent>
              ...
              >
                EXPLORE COURSES <ArrowRight className="" />
              </TimelineContent>
            </div>
          </div>
        </div>
